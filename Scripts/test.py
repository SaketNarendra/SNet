...
parser.add_argument('--data.max_len_subwords', type=int, default=default_max_len_subwords, metavar="MLSW",
                    help="maximum length of word in subwords/ characters (default: {})".format(
...
parser.add_argument('--data.subword_dict_dir', type=str, default="runs/10000/subwords_dict3.p", metavar="SUBWORD_DICT",
                    help="directory of the subword dictionary")
parser.add_argument('--data.word_dict_dir', type=str, default="runs/10000/words_dict3.p", metavar="WORD_DICT",
                    help="directory of the word dictionary")
parser.add_argument('--data.char_dict_dir', type=str, default="runs/10000/chars_dict3.p", metavar="	CHAR_DICT",
...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        if FLAGS["model.emb_mode"] == 1:
            ...
            batches = batch_iter(list(zip(ngramed_id_x, worded_id_x, chared_id_x)), FLAGS["test.batch_size"], 1,
                                 shuffle=False)
        all_predictions = []
        all_scores = []
        ...
        it = tqdm(range(nb_batches), desc="emb_mode {} delimit_mode {} test_size {}".format(FLAGS["model.emb_mode"],
