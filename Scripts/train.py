...
with tf.Graph().as_default(): 
    ...
    with sess.as_default():  
        ...
        ngrams_dict_dir = FLAGS["log.output_dir"] + "subwords_dict3.p"
        pickle.dump(ngrams_dict, open(ngrams_dict_dir,"wb"))  
        words_dict_dir = FLAGS["log.output_dir"] + "words_dict3.p"
        pickle.dump(words_dict, open(words_dict_dir, "wb"))
        chars_dict_dir = FLAGS["log.output_dir"] + "chars_dict3.p"
